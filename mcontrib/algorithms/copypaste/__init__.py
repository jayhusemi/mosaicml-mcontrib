...
from mcontrib.algorithms.copypaste.copypaste import CopyPaste as CopyPaste
from mcontrib.algorithms.copypaste.copypaste import copypaste_batch as copypaste_batch
